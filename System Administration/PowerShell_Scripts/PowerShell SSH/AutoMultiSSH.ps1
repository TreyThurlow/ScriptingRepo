<#
.SYNOPSIS
Builds a specified amount of PowerShell Panes for SSH connections

.DESCRIPTION
This script will create several PowerShell Panes based on how many servers you enter at the bottom of the script. You will be required to enter the servernames and login information to be able to connect to the systems in the script. 
#>
